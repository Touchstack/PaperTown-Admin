            ...
            <div className="font-Regular max-w-[470px] lg:text-xl md:text-lg sm:text-lg text-lg lg:text-left md:text-left text-center">
              <form name="chaperonDetails" method="post">
                <div className="flex gap-4">
                  <div className="relative z-0 w-1/2 mb-6 group text-sm tracking-wider font-Medium text-[#393939]">
                    <label
                      htmlFor="firstName"
                  ...
                  <div className="relative z-0 w-1/2 mb-6 group text-sm tracking-wider font-Medium text-[#393939]">
                    ...
                    <input
                      ...
                      name="lastName"
                      placeholder="Njoku"
                      className="block w-[180px] tracking-wider h-[55px] p-3 text-[#000000] font-SemiBold rounded-lg bg-[#F4F5F7] sm:text-md outline-none focus:outline-amber-300"
                    />
                  </div>
                </div>
                <div className="relative z-0 w-full mb-6 group tracking-wider text-sm font-Medium text-[#393939]">
