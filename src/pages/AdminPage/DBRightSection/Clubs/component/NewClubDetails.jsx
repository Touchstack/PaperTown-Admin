  ...
  return (
    <div className="container mx-auto rounded-md py-4">
      <div className="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-4">
        ...
        <div className="inline-flex mb-6 justify-center items-center img-fluid mx-8 mb-20">
          <div className="py-14 px-8 lg:ml-14">
            <h3 className="mt-2 font-Bold lg:text-4xl md:text-3xl sm:text-3xl text-3xl lg:text-left text-center py-4 text-[#000]">
              Chaperon details
            </h3>
            <div className="py-6">
